 ...
 */
public class GZIPPeakListWriter extends CompressedPeakListWriter {
    ...
    public GZIPPeakListWriter(String filename) {
        super(filename);
        ...
        if (extensionToUse == null) {
            throw new RuntimeException(filename+" does not have a valid GZIP extension!");
        }
