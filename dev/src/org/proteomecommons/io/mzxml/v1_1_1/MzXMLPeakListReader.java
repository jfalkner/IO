...
/**
 * This class is intended to be a complete implementation of the MZXML 1.1.1 file format. Users may sub-cast to a <code>org.proteomecommons.io.mzxml.v2_0.MZXMLPeakListReader</code> to take advantage of the meta-information.
 *
                    ...
                    case XMLStreamConstants.START_ELEMENT:
                        ...
                        // handle the msManufacturer
                            ...
                            if (msRun.getMsInstrument() == null) {
                                throw new InvalidFileFormatException("mzXML 1.1.1 requires that you declare msManufacture elements within a msInstrument element.");
                            }
                            // get the info
                        ...
                        // handle the MsModel
                            ...
                            // check for the msInstrument
                            if (msRun.getMsInstrument() == null) {
                                throw new InvalidFileFormatException("mzXML 1.1.1 requires that you declare msModel elements within a msInstrument element.");
                            }
                            // get the info
                        ...
                        // handle the MsIonisation
                            ...
                            // check for the msInstrument
                            if (msRun.getMsInstrument() == null) {
                                throw new InvalidFileFormatException("mzXML 1.1.1 requires that you declare msIonisation  elements within a msInstrument element.");
                            }
                            // get the info
                        ...
                        // handle the MsMassAnalyzer
                            ...
                            // check for the msInstrument
                            if (msRun.getMsInstrument() == null) {
                                throw new InvalidFileFormatException("mzXML 1.1.1 requires that you declare msMassAnalyzer elements within a msInstrument element.");
                            }
                            // get the info
                        ...
                        // handle the MsDetector
                            ...
                            // check for the msInstrument
                            if (msRun.getMsInstrument() == null) {
                                throw new InvalidFileFormatException("mzXML 1.1.1 requires that you declare msDetector elements within a msInstrument element.");
                            }
                            // get the info
