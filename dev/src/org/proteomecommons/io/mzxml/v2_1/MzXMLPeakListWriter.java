...
/**
 *<p>An implementation of a PeakListWriter class that saves data in the MZXML 2.1 schema format.</p>
...
public class MzXMLPeakListWriter extends GenericPeakListWriter {
    ...
    public MzXMLPeakListWriter(String filename){
        ...
        try {
            ...
            xmlw.writeAttribute("xmlns","http://sashimi.sourceforge.net/schema_revision/mzXML_2.1");
            xmlw.writeAttribute("xmlns:xsi", "http://www.w3.org/2001/XMLSchema-instance");
            xmlw.writeAttribute("xsi:schemaLocation", "http://sashimi.sourceforge.net/schema_revision/mzXML_2.1 http://sashimi.sourceforge.net/schema_revision/mzXML_2.1/mzXML_idx_2.1.xsd");
