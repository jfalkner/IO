...
/**
 * A MGF-specific peak list class. This class carries meta-info that is specific to the Mascot search engine.
 * 
 * @author Jayson Falkner - jfalkner@umich.edu
 */
public class MascotGenericFormatPeakList extends PeakList {
	...
	* Composition qualifier. Null if not known(.mgf)
	 ...
	 * 
	 * @param Tolerance of the Peak List 
	 */
	 ...
	 * 
	 * @param Tolerance Unit of the Peak List 
	 */
	 ...
	 * 
	 * @param Sequence Qualifier of the Peak List 
	 */
	 ...
	 * 
	 * @param Composition Qualifier of the Peak List 
	 */
