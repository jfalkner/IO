 ...
 *  
 */
public class MicromassPKLPeakListWriter extends PeakListWriter {
	OutputStream out;
	...
	public void write(PeakList peaklist) throws Exception {
		...
		osw.write(peaklist.parentIonMassOverChargeInDaltons + " "
				+ peaklist.getIntensity() + " " + peaklist.parentIonCharge
				+ "\n");
	...
	public void startPeakList(double parentIonMassOverChargeInDaltons,
		...
		startPeakList(parentIonMassOverChargeInDaltons, -1, charge);
	}
	...
	public void startPeakList(double parentIonMassOverChargeInDaltons,
		...
		insidePeakList = true;
		osw.write(parentIonMassOverChargeInDaltons + " " + intensity + " "
				+ parentIonCharge + "\n");
