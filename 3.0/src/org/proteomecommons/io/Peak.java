...
public class Peak implements Comparable {
	...
	/**
	 * Public constructor of the class. All peaks must have a m/z value, but
	...
	/**
	 * Public constructor that initializes the peak with both an intensity and a
	 * m/z value.
	 * 
	 * @param massOverChargeInDaltons
	 *            The fragment's mass over charge in daltons (x-axis)
	...
	/**
	 * Public constructor that initializes the peak with an intensity, a m/z
	 * value, and a charge state. The m/z value is assumed to be the m/z
	 * accounting for the charge -- it is not modified..
	 * 
	 * @param massOverChargeInDaltons
	 *            The fragment's mass over charge in daltons (x-axis)
	 * @param intensity
