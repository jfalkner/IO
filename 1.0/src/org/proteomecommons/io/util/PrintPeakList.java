 ...
 *
 * Print the peak list. A simple method to test if a peak list reader is correctly reading peaks.
 */
public class PrintPeakList {
	public static void main(String[] args){
		...
		PeakList pl = PeakListReader.read(args[0]);
		for (int i=0;i<pl.peaks.length;i++){
			System.out.println(pl.peaks[i].intensity+", "+pl.peaks[i].charge);
		}
